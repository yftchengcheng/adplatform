  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          previewMode
            ? "relative w-full bg-gradient-to-b from-[#1a0a2e] to-[#2d1b4e]"
      ...
      >
        ...
        <button
          onClick={onClose}
          className="absolute top-2 right-2 z-10 w-5 h-5 flex items-center justify-center rounded-full bg-black/30 hover:bg-black/50 transition-colors"
        >
