...
// 默认配置
export const defaultFlipCardConfig: FlipCardConfig = {
  guideText: "点击卡牌，领取奖品",
  guideTextMacro: "",
  rewardType: "cash",
  cashAmount: "88.88",
...
export function FlipCardTemplateConfigPanel({
  ...
  const updateConfig = useCallback(
    (updates: Partial<FlipCardConfig>) => {
    ...
    <div className="space-y-4">
      ...
      <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
        ...
        <div className="p-4 space-y-4">
          {/* 卡牌图片 */}
          <div className="space-y-2">
            <label className="text-sm font-medium text-gray-700">卡牌图片</label>
            <ImageUpload
      ...
      <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
        ...
        {basicOpen && (
          <div className="p-4 space-y-4 border-t border-gray-200">
            <div className="space-y-2">
              <Input
                value={config.componentName || "点击卡牌领取奖品"}
...
export default FlipCardTemplateConfigPanel;
